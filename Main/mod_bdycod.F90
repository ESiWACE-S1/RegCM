...
!!$acc& .or. ma%has_bdyright .or. ma%has_bdybottom .or. ma%has_bdytop))
!!$acc data copyin(xib, xib%b0) if(present_qi .and. ipptls > 1 .and. (ma%has_bdyleft&
!!$acc& .or. ma%has_bdyright .or. ma%has_bdybottom .or. ma%has_bdytop))
        if ( ma%has_bdyleft ) then
!!$acc parallel present(mo_atm, mo_atm%t, mo_atm%qx, mo_atm%pai, xtb, xtb%b0, xqb, xqb%b0, xpaib, xpaib%b0)
!!$acc loop collapse(2)
          do k = 1 , kz
            do i = ici1 , ici2
...
!!$acc end data
      ...
      !
      if ( idynamic == 3 ) then
!!$acc data copyin(xtb, xtb%b0, xtb%bt, xqb, xqb%b0, xqb%bt, xpaib, xpaib%b0, xpaib%bt) if(ma%has_bdyleft&
!!$acc& .or. ma%has_bdyright .or. ma%has_bdybottom .or. ma%has_bdytop)
!!$acc data copyin(xlb, xlb%b0, xlb%bt) if(present_qc .and. (ma%has_bdyleft&
!!$acc& .or. ma%has_bdyright .or. ma%has_bdybottom .or. ma%has_bdytop))
!!$acc data copyin(xib, xib%b0, xib%bt) if(present_qi .and. ipptls > 1 .and. (ma%has_bdyleft&
!!$acc& .or. ma%has_bdyright .or. ma%has_bdybottom .or. ma%has_bdytop))
        if ( ma%has_bdyleft ) then
!!$acc parallel present(mo_atm, mo_atm%t, mo_atm%qx, mo_atm%pai, xtb, xtb%b0, xtb%bt, xqb, xqb%b0, xqb%bt,&
