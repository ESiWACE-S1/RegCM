...
!$acc end parallel
!$acc parallel present(atms, atms%pf3d, atms%pb3d, atms%rhob3d, atms%zq, atms%za)
!$acc loop collapse(2)
      do i = ice1, ice2
        do j = jce1, jce2
...
!$acc end parallel
!$acc parallel present(atms, atms%rhox2d, atms%ps2d, atms%tb3d, atms%tp2d, atms%pb3d)
!$acc loop collapse(2)
      do i = ici1, ici2
        do j = jci1, jci2
